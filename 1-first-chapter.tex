...
\begin{itemize}
    \item \textbf{B2C (Business-to-Consumer) :} modèle dans lequel une entreprise commercialise directement ses produits ou services auprès des consommateurs finaux. Les achats concernent généralement de faibles quantités et le processus de décision est relativement rapide \citeURL{b2c_definition}.

    \item \textbf{B2B (Business-to-Business) :} modèle dans lequel les échanges s'effectuent entre entreprises. Les transactions portent souvent sur des produits techniques ou spécialisés, impliquent des volumes plus importants et suivent un processus d'achat plus structuré \citeURL{b2b_definition}.
\end{itemize}
\newpage
