...
Pour construire les requêtes et exploiter les réponses JSON, SAP Commerce Cloud utilise la bibliothèque \textit{Jackson} de Java. La classe \texttt{ObjectMapper} permet de convertir les objets Java en données JSON lors de l'envoi et de transformer les réponses JSON reçues en objets Java.
